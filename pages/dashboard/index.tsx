            ...
            <div className="mt-12">
                <div className="grid grid-cols-4 gap-12 mt-12">
                    <div className="w-60 h-60 bg-slate-600 text-white p-6 flex flex-col rounded-lg shadow-lg">
                        ...
                        <div className="h-full flex justify-center items-center text-4xl font-bold">{totalPeserta.isLoading ? <RiLoader5Line className="animate-spin" /> : totalPeserta.data?.data}</div>
                    </div>
                    <div className="w-60 h-60 bg-slate-600 text-white p-6 flex flex-col rounded-lg shadow-lg">
                        <h3 className="font-light tracking-wider text-center">Jumlah Ujian</h3>
                        <div className="h-full flex justify-center items-center text-4xl font-bold">{totalUjian.isLoading ? <RiLoader5Line className="animate-spin" /> : totalUjian.data?.data}</div>
                    </div>
                    {/* <div className="w-60 h-60 bg-slate-600 text-white p-6 flex flex-col rounded-lg shadow-lg">
                        <h3 className="font-light tracking-wider text-center">Jumlah Pendaftar</h3>
